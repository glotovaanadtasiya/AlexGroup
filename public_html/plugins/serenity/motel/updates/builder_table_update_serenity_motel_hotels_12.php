...
class BuilderTableUpdateSerenityMotelHotels12 extends Migration
{
    public function up()
    {
        Schema::table('serenity_motel_hotels', function($table)
        {
            $table->string('yandex_map_link', 255)->nullable()->unsigned(false)->default(null)->change();
            $table->string('google_map_link', 255)->nullable()->unsigned(false)->default(null)->change();
        });
    }
